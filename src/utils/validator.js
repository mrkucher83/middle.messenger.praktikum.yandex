export default function validateInput(event) {
  ...
  if (event && event.target.name === 'login') {
    const isValidate = regEx.login.test(event.target.value);
    !isValidate
  ...
  if (
    ...
    const isValidate = regEx.name.test(event.target.value);
    !isValidate
  ...
  if (event && event.target.name === 'email') {
    const isValidate = regEx.email.test(event.target.value);
    !isValidate
  ...
  if (event && event.target.name === 'phone') {
    const isValidate = regEx.phone.test(event.target.value);
    !isValidate
  ...
  if (
    ...
    const isValidate = regEx.password.test(event.target.value);
    !isValidate
